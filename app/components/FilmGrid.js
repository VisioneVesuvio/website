...
const sampleFilmsData = [
    ...
    { id: 4, title: 'Annie Hall', frontImage: '/film/hannie_hall.png', youtubeVideoId: 'OqVgCfZX-yE?si=ILfA60vJLMdw0m0A', backText: '20 Luglio', locationInfo: 'Villa Floridiana, Napoli.' },
    { id: 5, title: 'Alice in Wonderland (1956)', frontImage: '/film/alice.png', youtubeVideoId: 'XMVwQcjn3NY?si=dsM2B875fma3oSYv', backText: '27 Luglio', locationInfo: 'Villa Floridiana, Napoli.' },
    { id: 6, title: 'Blue Velvet', frontImage: '/film/blue_velvet.png', youtubeVideoId: 'rAA6imfqMYQ', backText: '03 Agosto', locationInfo: 'Villa Floridiana, Napoli.' },
    { id: 7, title: 'Brazil', frontImage: '/film/brazil.png', youtubeVideoId: '4Gqjdscj3e8?si=DK7Asl-4lDDzZObc', backText: '07 Settembre', locationInfo: 'Villa Floridiana, Napoli.' },
    { id: 8, title: '8½', frontImage: '/film/8_1_2.png', youtubeVideoId: 'RmIC9pQ80Fk?si=WFoplnBk-wJkpSUb', backText: '14 Settembre', locationInfo: 'Villa Floridiana, Napoli.' },
    { id: 9, title: 'Paris, Texas', frontImage: '/film/paris_texas.png', youtubeVideoId: '3j8ypqxfiT4?si=SpBDMBw3O4BrwHR9', backText: '21 Settembre', locationInfo: 'Villa Floridiana, Napoli.' },
];
