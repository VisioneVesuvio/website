...
const sampleFilmsData = [
    { id: 1, title: 'In The Mood For Love', frontImage: '/film/in_the_mood_for_love.jpg', frontText: null, backText: '15 Giugno' },
    { id: 2, title: 'Her', frontImage: '/film/her.jpg', frontText: null, backText: '22 Giugno' },
    { id: 3, title: 'Ex Machina', frontImage: '/film/ex-machina.jpg', frontText: null, backText: '29 Giugno' },
    { id: 4, title: 'Annie Hall', frontImage: '/film/hannie_hall.jpg', frontText: null, backText: '06 Luglio' }, // Card solo testo
    { id: 5, title: 'Blue Velvet', frontImage: '/film/blue_velvet.jpg', frontText: null, backText: '13 Luglio' }, // Card solo testo
    { id: 6, title: '8½', frontImage: '/film/8_1_2.jpg', frontText: null, backText: '20 Luglio' },
    { id: 7, title: 'Alice Wonderland', frontImage: '/film/alice.jpg', frontText: null, backText: '27 Luglio' },
    { id: 8, title: 'Brazil', frontImage: '/film/brazil.jpg', frontText: null, backText: '03 Agosto' }, // Card solo testo
    { id: 9, title: 'Paris, Texas', frontImage: '/film/paris_texas.jpg', frontText: null, backText: '10 Agosto' },
];
